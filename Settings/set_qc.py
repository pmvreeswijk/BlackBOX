...
qc_range = {
    'ML1': {
        ...
        'RDIF-MAX': {'default':'None', 'val_type': 'sigma',   'val_range': {'u': [ (0.026, 0.002) ],
                                                                            ...
                                                                            'r': [ (0.011, 0.001) ],
                                                                            'i': [ (0.014, 0.001) ],
                                                                            'z': [ (0.023, 0.001) ]},           'key_type': 'flat', 'pos': True , 'comment': '(max(subs)-min(subs)) / (max(subs)+min(subs))'},
        ...
        'RSTD-MAX': {'default':'None', 'val_type': 'sigma',   'val_range': {'u': [ (0.073, 0.001) ],
                                                                            ...
                                                                            'r': [ (0.043, 0.001) ],
                                                                            'i': [ (0.028, 0.001) ],
                                                                            'z': [ (0.023, 0.0005)]},           'key_type': 'flat', 'pos': True , 'comment': 'max. relative sigma (STD) of subimages'},
